...
<div className="relative overflow-hidden before:absolute before:top-0 before:start-1/2 before:bg-[url('https://preline.co/assets/svg/examples/polygon-bg-element.svg')] dark:before:bg-[url('https://preline.co/assets/svg/examples-dark/polygon-bg-element.svg')] before:bg-no-repeat before:bg-top before:bg-cover before:size-full before:-z-[1] before:transform before:-translate-x-1/2">
  <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
    ...
    <div className="flex justify-center">
      ...
      href="https://edulga.ai" target="_blank">
       Empowering learning through innovative online education
    ...
    <div className="mt-5 max-w-2xl text-center mx-auto">
      ...
      Edulga
        <span className="bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent"> AI Learning Hub </span>
      </h1>
    </div>
    ...
    <div className="mt-5 max-w-3xl text-center mx-auto">
      ...
      Empower your learning journey with Edulga&#39;s AI-driven platform, delivering personalized, high-quality courses and the fastest learning paths for every subject—designed to optimize your growth, one concept at a time.</p>
    </div>
